...
h.forEach=function(a,b){for(var c=this.getKeys(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};function Mc(a,b){return Object.prototype.hasOwnProperty.call(a,b)};var Nc=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;function Oc(a){ic.call(this);this.headers=new Jc;this.da=a||null;this.f=!1;this.ca=this.a=null;this.Qa=this.X="";this.b=0;this.g="";this.h=this.Aa=this.W=this.za=!1;this.m=0;this.wa=null;this.V=Pc;this.xa=this.D=!1}m(Oc,ic);var Pc="",Qc=Oc.prototype,Rc=xc("goog.net.XhrIo");Qc.F=Rc;var Sc=/^https?$/i,Tc=["POST","PUT"];h=Oc.prototype;h.Ya=function(){return this.V};h.Za=function(){return this.D};
...
new Jc(this.headers);d&&Ic(d,function(a,b){e.set(b,a)});d=Ka(e.getKeys());c=k.FormData&&a instanceof k.FormData;!(0<=Ia(Tc,b))||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(a,b){this.a.setRequestHeader(b,a)},this);this.V&&(this.a.responseType=this.V);"withCredentials"in this.a&&this.a.withCredentials!==this.D&&(this.a.withCredentials=this.D);try{Wc(this),0<this.m&&(this.xa=Xc(this.a),yc(this.F,Uc(this,"Will abort after "+this.m+"ms if incomplete, xhr2 "+
this.xa)),this.xa?(this.a.timeout=this.m,this.a.ontimeout=ya(this.eb,this)):this.wa=kc(this.eb,this.m,this)),yc(this.F,Uc(this,"Sending request")),this.W=!0,this.a.send(a),this.W=!1}catch(f){yc(this.F,Uc(this,"Send error: "+f.message)),Vc(this,f)}};function Xc(a){return ab&&vb(9)&&"number"==typeof a.timeout&&ma(a.ontimeout)}function La(a){return"content-type"==a.toLowerCase()}
h.eb=function(){"undefined"!=typeof la&&this.a&&(this.g="Timed out after "+this.m+"ms, aborting",this.b=8,yc(this.F,Uc(this,this.g)),v(this,"timeout"),this.abort(8))};function Vc(a,b){a.f=!1;a.a&&(a.h=!0,a.a.abort(),a.h=!1);a.g=b;a.b=5;Yc(a);Zc(a)}function Yc(a){a.za||(a.za=!0,v(a,"complete"),v(a,"error"))}h.abort=function(a){this.a&&this.f&&(yc(this.F,Uc(this,"Aborting")),this.f=!1,this.h=!0,this.a.abort(),this.h=!1,this.b=a||7,v(this,"complete"),v(this,"abort"),Zc(this))};
...
function Yf(a,b,c,d,e,f,g,r,G,q,W,x,B){this.c=a||null;this.h=d||null;this.V=W||null;this.m=e||null;b?(a=new He,F(a,1,b)):a=null;if(b&&c)b=new Ie,F(b,2,c),L(b,1,a);else{if(b&&c)throw new Xf("Cannot provide location context without partner context.");b=null}this.location=b;g&&"string"===typeof g?(c=new Je,F(c,2,g),c.N(b)):c=null;this.f=c;f?(g=new Ke,F(g,1,f),f=g):f=null;this.D=f;q?(f=new qf,F(f,1,q),q=f):q=null;this.X=r||null;this.W=G?G.a():null;this.order=q;this.g=x||null;this.o=B||null}
...
this.Ib,this.Gb,a,b);Tg(b)};h.Oa=function(a){if(!E(a,3,""))throw new Xf("Missing device fingerprint ID.");if(!E(a,4,""))throw new Xf("Missing device session ID.");};function ch(a,b,c,d){this.c=a;this.h=d||+new Date;a=new Yf(this.c);bh.apply(this,[a,"EVENT",b,this.h])}m(ch,bh);ch.prototype.m=function(){return this.c.name.startsWith("_bloom_")};ch.prototype.Oa=function(a){bh.prototype.Oa.apply(this,[a]);if(!this.m&&(a=nf(a).K(),-1===a.indexOf("partner/")||-1===a.indexOf("location/")))throw new Xf("Must specify a location code before sending analytics events.");};
ch.prototype.a=function(){var a=new uf,b=new De,c={event:{payload:this.b}},d=+new Date;Ge(b,this.h||d);c&&"object"===typeof c&&(c=ce(c),L(a,1,c));L(a,2,b);return a};function dh(a){return["_bloom_:v1beta3",a].join(":")}var eh=dh("library"),fh=dh("pageview"),gh=dh("orders"),hh=dh("enrollment"),ih=dh("verification");function jh(a,b,c,d){a="string"!==typeof a?a:Kf(a);return new ch(a,b,null,d)}l("bloombox.telemetry.event",jh);l("bloombox.shop.enroll.EnrollmentException",function(a){this.message=a});function U(a,b,c,d,e,f,g){this.b=this.key=this.id=null;this.source=a;this.channel=b;this.person=c;this.doctorRec=d;this.license=e;this.a=null!==f&&void 0!==f?btoa(f):null;this.profile=g||null;this.dryRun=!1}l("bloombox.shop.enroll.Enrollment",U);U.prototype.l=function(){return this.id};U.prototype.getId=U.prototype.l;U.prototype.getKey=function(){return this.key};U.prototype.getKey=U.prototype.getKey;U.prototype.P=function(){return this.b};
U.prototype.getForeignId=U.prototype.P;U.prototype.ub=function(){this.dryRun=!0;return this};U.prototype.enableDryRun=U.prototype.ub;U.prototype.S=function(a,b,c,d){jh(hh,{action:c?"error":"enroll",status:d?d:200,customer:{foreignId:this.b.trim()},enrollment:{key:this.key.trim(),channel:this.channel,source:this.source}}).send()};
...
Z.prototype.update=Z.prototype.update;Z.prototype.S=function(a,b,c){var d=0,e={},f={},g=[],r=[];this.b.map(function(a){var b=a.key.l();d+=a.count;e[b]?e[b]+=a.count:(e[b]=a.count,g.push(b));b=a.key.Ia();f[b]?f[b]+=a.count:(f[b]=a.count,r.push(b))});jh(gh,{action:b?"error":"order",status:c?c:200,order:{id:a,type:this.type,items:g,sections:r,stats:{countByKey:e,countBySection:f,hasOrderNotes:"string"===typeof this.J()&&0<this.J().length,uniqueItemCount:this.b.length,totalItemCount:d||1}}}).send()};
