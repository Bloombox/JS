...
this.c+"\nFailure code: "+this.a.b+"\nFailure reason: "+bd(this.a)+'\nResponse: "';f=this.a;try{var x=f.a?f.a.responseText:""}catch(oa){yc(f.D,"Can not get responseText: "+oa.message),x=""}B.message=G+x+'".';p("Failed to resolve RPC.",{xhr:this.a,error:B});gd(B)}}}}.bind(a)}
...
U.prototype.send=U.prototype.send;function mh(a){this.message=a}l("bloombox.shop.ShopInfoException",mh);mh.prototype.Z=function(){return this.message};mh.prototype.getMessage=mh.prototype.Z;
