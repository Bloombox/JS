...
function wn(a, c, b, d, f, g) {
  if (!a || "string" !== typeof a) {
    throw new vn("Invalid first address line: '" + a + "'.");
  }
  if (!b || "string" !== typeof b) {
    throw new vn("Invalid address city: '" + b + "'.");
  }
  if (!f || "string" !== typeof f) {
    throw new vn("Invalid address zip: '" + f + "'.");
  }
  if (!d || "string" !== typeof d) {
    throw new vn("Invalid address state: '" + d + "'.");
  }
  this.Fa = a;
  this.va = c || null;
  this.city = b;
...
l("bloombox.identity.StreetAddress", wn);
wn.prototype.Ka = function() {
  return this.Fa;
};
wn.prototype.getFirstLine = wn.prototype.Ka;
wn.prototype.Na = function() {
  return this.va || null;
};
wn.prototype.getSecondLine = wn.prototype.Na;
wn.prototype.Ia = function() {
  return this.city;
};
wn.prototype.getCity = wn.prototype.Ia;
...
wn.prototype.getZipcode = wn.prototype.Oa;
function xn(a, c, b) {
  if (!a || "string" !== typeof a) {
    throw new vn("Invalid email address: '" + a + "'.");
  }
  this.emailAddress = a;
  this.phoneNumber = c || null;
  this.streetAddress = b || null;
}
l("bloombox.identity.ContactInfo", xn);
xn.prototype.Ja = function() {
  return this.emailAddress;
};
xn.prototype.getEmailAddress = xn.prototype.Ja;
xn.prototype.Ma = function() {
  return this.phoneNumber;
};
xn.prototype.getPhoneNumber = xn.prototype.Ma;
xn.prototype.Cb = function() {
  return this.streetAddress;
};
xn.prototype.getStreetAddress = xn.prototype.Cb;
function yn(a, c, b, d) {
  if (!a || "string" !== typeof a) {
    throw new vn("Invalid first name: '" + a + "'.");
  }
  if (!c || "string" !== typeof c) {
    throw new vn("Invalid last name: '" + c + "'.");
  }
  if (!b) {
    throw new vn("Invalid contact info: '" + c + "'.");
  }
  if (null !== d && (!d || "string" !== typeof d)) {
    throw new vn("Invalid date of birth (must be in YYYY-MM-DD format): '" + d + "'.");
  }
  let f = new kk;
  L(f, 2, a);
  L(f, 3, c);
...
l("bloombox.identity.Person", yn);
yn.prototype.X = function() {
  return this.name.X();
};
yn.prototype.getFirstName = yn.prototype.X;
yn.prototype.Y = function() {
  return this.name.Y();
};
yn.prototype.getLastName = yn.prototype.Y;
yn.prototype.Bb = function() {
  return this.a;
};
yn.prototype.getContactInfo = yn.prototype.Bb;
yn.prototype.ma = function() {
  return null !== this.Ea ? G(this.Ea, 1, "") : null;
};
yn.prototype.getDateOfBirth = yn.prototype.ma;
function zn(a) {
  this.message = a;
}
l("bloombox.shop.CustomerException", zn);
function An(a, c) {
  if (!("string" === typeof c && 0 < c.length)) {
    throw new zn("Invalid customer foreign ID. Must be a valid string over length 1.");
  }
  this.s = a;
  this.Ga = c;
  this.Ua = null;
}
l("bloombox.shop.Customer", An);
An.prototype.oa = function() {
  return this.s;
};
An.prototype.getPerson = An.prototype.oa;
An.prototype.La = function() {
  return this.Ga;
};
An.prototype.getForeignId = An.prototype.La;
An.prototype.L = function() {
  return this.Ua;
};
An.prototype.getUserKey = An.prototype.L;
An.prototype.Qb = function(a) {
  if (null !== a && ("+" !== a[0] || 5 > a.length || 16 < a.length)) {
    throw new zn("Invalid phone number: " + a);
  }
  this.s.a.phoneNumber = null === a ? null : a;
  return this;
};
An.prototype.setPhoneNumber = An.prototype.Qb;
...
An.prototype.K = function() {
  ...
  if ("string" !== typeof this.s.a.emailAddress || 3 > this.s.a.emailAddress.length || 2 !== this.s.a.emailAddress.split("@").length) {
    throw new zn("Must provide a valid email address.");
  }
  L(b, 1, this.s.a.emailAddress);
  Q(c, 3, b);
  if (null === this.s.a.phoneNumber) {
    throw new zn("Must provide a valid phone number.");
  }
  b = new Yj;
...
l("bloombox.shop.ShopOptions", Bn);
Bn.fromObject = function(a) {
  return new Bn(a.scope || null);
};
Bn.defaults = function() {
  return new Bn(null);
};
function Cn(a, c) {
  if (!c) {
...
l("bloombox.telemetry.Collection", Cn);
function Dn(a) {
  return new Cn(a);
}
Cn.named = Dn;
...
function En() {
  return !Fn() && (q("iPod") || q("iPhone") || q("Android") || q("IEMobile"));
}
function Fn() {
...
function Kn(a, c, b, d, f, g, k, p, I, da, Ac, lh, Uo) {
  this.R = a || null;
  this.D = d || null;
  this.Ba = Ac || null;
  this.c = f || null;
...
Kn.prototype.K = function() {
  ...
  this.Ba ? Q(a, 8, this.Ba) : (c = new Vl, b = In(), R(c, 10, Wl[0], b), Q(a, 8, c));
  c = new fm;
  b = new Ol;
  N(b, 1, Pl[0], "v2.0.0-rc4");
  Q(c, 2, b);
  L(c, 1, "full");
  M(c, 3, 1);
  Q(a, 9, c);
...
l("bloombox.telemetry.TelemetryOptions", Mn);
Mn.fromObject = function(a) {
  return new Mn(a.scope || null);
};
Mn.defaults = function() {
  return new Mn(null);
};
...
;var Qn = {};
function Rn() {
  let a = {kb:Sn, ne:Tn, Lc:Un, ve:Vn, Gb:Wn, Hb:Xn};
  Object.isFrozen && !Object.isFrozen(a) && Object.freeze(a);
  return a;
}
Qn.$ = !0;
Qn.rb = !0;
var Wn = null, Xn = null, Sn = 0, Tn = 0, Un = 0, Vn = 0;
function Yn() {
  let a = "", c, b;
  for (c = 0; 32 > c; c++) {
    b = 16 * Math.random() | 0;
...
;var jo = new Fc({Accept:"application/json,*/*"}), Pn = {PING:"GET", EVENT:"POST", EXCEPTION:"POST", SECTION_IMPRESSION:"GET", SECTION_VIEW:"GET", SECTION_ACTION:"GET", PRODUCT_IMPRESSION:"GET", PRODUCT_VIEW:"GET", PRODUCT_ACTION:"GET", USER_ACTION:"GET", ORDER_ACTION:"GET"}, On = {PING:() => "ping", EVENT:a => `${O(a, im, 1).getName()}:event`};
function ko(a) {
  zb.call(this);
  this.b = a;
  this.a = {};
...
m(to, zb);
var uo = "[goog.structs.Pool] Min can not be greater than max";
e = to.prototype;
e.na = function() {
  var a = qa();
  if (!(null != this.j && a - this.j < this.delay)) {
    for (var c; 0 < qo(this.a) && (c = po(this.a), !this.Sa(c));) {
      this.ha();
    }
    !c && vo(this) < this.c && (c = this.Da());
    c && (this.j = a, this.b.add(c));
    return c;
  }
};
function wo(a, c) {
  Jc(a.b.a, so(c)) && a.Aa(c);
}
e.Aa = function(a) {
  Jc(this.b.a, so(a));
  this.Sa(a) && vo(this) < this.c ? this.a.a.push(a) : xo(a);
};
e.ha = function() {
  for (var a = this.a; vo(this) < this.m;) {
    var c = this.Da();
    a.a.push(c);
  }
  for (; vo(this) > this.c && 0 < qo(this.a);) {
    xo(po(a));
  }
};
e.Da = function() {
...
e.na = function(a, c) {
  if (!a) {
    return (a = yo.I.na.call(this)) && this.delay && (this.l = h.setTimeout(pa(this.pa, this), this.delay)), a;
  }
  ao(this.i, ba(c) ? c : 100, a);
  this.pa();
};
e.pa = function() {
...
function Ao(a, c, b, d, f, g) {
  dc.call(this);
  this.l = ba(a) ? a : 1;
  this.j = ba(f) ? Math.max(0, f) : 0;
  this.m = !!g;
  this.b = new zo(c, b, d, g);
  this.a = new Fc;
  this.c = new ko(this);
}
m(Ao, dc);
var Bo = "ready complete success error abort timeout".split(" ");
Ao.prototype.abort = function(a, c) {
  var b = this.a.get(a);
  if (b) {
    var d = b.wa;
    b.Xa = !0;
    c && (d && (mo(this.c, d, Bo, b.Va), Sb(d, "ready", function() {
      wo(this.b, d);
    }, !1, this)), Jc(this.a, a));
    d && d.abort();
  }
};
Ao.prototype.u = function(a, c) {
  var b = this.a.get(a);
  if (b && !b.wa) {
    var d = this.c, f = b.Va, g = Bo;
    ia(g) || (g && (lo[0] = g.toString()), g = lo);
    for (var k = 0; k < g.length; k++) {
    ...
    case "complete":
      a: {
        ...
        if (7 == b.c || ad(b) || d.ia > d.Pa) {
          if (ec(this, new Co("complete", this, a, b)), d && (d.ab = !0, d.$a)) {
            a = d.$a.call(b, c);
            break a;
          }
        }
      ...
      return a;
    case "success":
      ec(this, new Co("success", this, a, b));
      break;
    case "timeout":
    case "error":
      c = this.a.get(a);
      c.ia > c.Pa && ec(this, new Co("error", this, a, b));
      break;
    case "abort":
      ec(this, new Co("abort", this, a, b));
  }
  return null;
};
function Do(a, c, b) {
  var d = a.a.get(c);
  !d || d.ab || d.ia > d.Pa ? (d && (mo(a.c, b, Bo, d.Va), Jc(a.a, c)), wo(a.b, b)) : (d.ia++, Sc(b, d.Ub, d.Ib, d.eb(), d.Db));
}
...
m(Co, Cb);
function Eo(a, c, b, d, f, g) {
  var k = ba(3) ? 3 : Fo.l, p = ba(!1) ? !1 : Fo.m;
  this.Ub = a;
  this.Ib = b || "GET";
  this.a = d;
  this.Db = f || null;
...
Eo.prototype.eb = function() {
  return this.a;
};
Eo.prototype.gb = function() {
  return this.b;
};
Eo.prototype.fb = function() {
  return "text";
};
var Go = {PING:5, EVENT:100, EXCEPTION:50, SECTION_IMPRESSION:999, SECTION_VIEW:100, SECTION_ACTION:50, PRODUCT_IMPRESSION:999, PRODUCT_VIEW:100, PRODUCT_ACTION:50, ORDER_ACTION:50}, Fo = new Ao(3, jo, 1, 5, 15E3, !1);
Fo.j = 15E3;
var ho = new function() {
  this.a = new co;
  this.count = 0;
...
function Ho() {
  let a = Rn(), c = io(function(b) {
    n("Sending telemetry event.", b.O, b.a);
    var d = b.a, f = Io(b), g = d.H ? JSON.stringify(d.H) : void 0;
    "PING" === d.a && (Wn = +new Date);
    var k = b.O, p = d.c, I = d.j, da = d.headers;
    d = b.priority;
    if (Fo.a.get(k)) {
      throw Error("[goog.net.XhrManager] ID in use");
    }
    p = new Eo(p, pa(Fo.C, Fo, k), I, g, da, f);
    Fo.a.set(k, p);
    k = pa(Fo.u, Fo, k);
    Fo.b.na(k, d);
    Tn++;
...
function Io(a) {
  return function(c) {
    if ("complete" === c.type) {
      ...
      "error" === c.type && (b = c.target.v(), ta("An error occurred while fulfilling a telemetry service RPC.", {queuedEvent:a, event:c, xhr:c.target}), Un++, a.a.i(1, 0, b));
    }
  };
}
var Jo = function(a, c, b) {
  let d;
  return function() {
  ...
  Qn.$ ? Qn.$ && Qn.rb ? 0 < Rn().kb ? 5 <= Fo.a.c ? Jo() : Ho() : n("No telemetry RPCs to send.") : (n("Tick skipped: telemetry is not active."), Jo()) : sa("Tick skipped: telemetry is not enabled.");
}, !0);
function Ko(a) {
  let c = Go[a.a], b = Yn(), d = eo(a, c, b);
  return new Promise((f, g) => {
    go(c, d, (k, p) => {
      !k || p ? g(p) : f(k);
    });
...
;var Lo = null, Mo = null, No = null, Oo = null;
function Po(a) {
  this.message = a;
}
...
function Qo(a) {
  ...
  if (null === c) {
    throw new Po("Failed to resolve global state of type: '" + c + "'.");
  }
  return c;
}
function Ro(a) {
...
function So() {
  if (null === Lo) {
    ...
    null === Mo && (Mo = Ro("bb:v1:t.df"));
    a = Mo;
    null === No && (No = Ro("bb:v1:t.sid"));
    var c = No;
    null === Oo && (Oo = Ro("bb:v1:t.oid"));
    var b = Oo;
    var d = new um;
    var f = 0;
    Gn ? f = 1 : Fn ? f = 3 : En && (f = 2);
    M(d, 1, f);
    M(d, 2, 0);
    if (window.screen) {
    ...
    R(k, 10, Wl[0], p);
    M(k, 1, 1);
    Lo = new Kn(null, I, da, a, c, null, window.__BLOOMBOX_DEVICE__ || null, null, null, b, k, f, d);
  }
  return Lo;
}
;function To(a, c) {
...
function Wo(a) {
  ...
  G(O(c, fm, 9), 1, "") && (f.library = {variant:G(O(c, fm, 9), 1, ""), version:Ln(O(O(c, fm, 9), Ol, 2))});
  null != E(c, 11) && (g = O(c, cm, 11), g = {browserType:G(g, 1, 0), version:Ln(O(g, Ol, 2)), language:G(g, 3, ""), userAgent:G(g, 4, ""), touchpoints:G(g, 5, 0), hardwareConcurrency:G(g, 6, 0), colorDepth:G(g, 7, 0)}, f.browser = g);
  null != E(c, 10) && (g = O(c, um, 10), g = {type:G(g, 1, 0), role:G(g, 2, 0), os:{type:G(O(g, lm, 3), 1, 0), version:Ln(O(O(g, lm, 3), Ol, 2))}, screen:{screen:{width:G(O(xm(g), om, 1), 1, 0), height:G(O(xm(g), om, 1), 2, 0)}, viewport:{width:G(O(xm(g), om, 2), 1, 0), height:G(O(xm(g), om, 2), 2, 0)}, density:G(xm(g), 3, 0), orientation:G(xm(g), 4, 0)}}, f["native"] = g);
...
Vo.prototype.i = function(a) {
  if (!G(a, 3, "")) {
    throw new Jn("Missing device fingerprint ID.");
  }
  if (!G(a, 4, "")) {
    throw new Jn("Missing device session ID.");
  }
};
function Xo(a, c, b, d) {
  this.R = a;
  this.sa = d || +new Date;
  a = new Kn(this.R);
  Vo.apply(this, [a, "EVENT", c, this.sa]);
}
m(Xo, Vo);
l("bloombox.telemetry.Event", Xo);
...
Xo.prototype.i = function(a) {
  Vo.prototype.i.apply(this, [a]);
  if (!this.j && (a = G(Bm(a), 1, ""), -1 === a.indexOf("partner/") || -1 === a.indexOf("location/"))) {
    throw new Jn("Must specify a location code before sending analytics events.");
  }
};
...
function ap(a, c, b) {
  a = "string" !== typeof a ? a : Dn(a);
  return new Xo(a, c, null, b);
}
var bp = class {
  constructor() {
  }
  a(a) {
    new Promise((c, b) => Yo((d, f) => {
  ...
  event(a, c, b) {
    return new Promise((d, f) => {
      So();
      var g = Wo(ap(a, c || null, b || +new Date));
      g = Ko(g);
      g.then(k => {
        d(k);
      });
...
function hp() {
  return "true" === window.sessionStorage.getItem("bb:1:t:opt_out") && !Qn.$;
}
...
function tp() {
  if (window.location.href !== rp) {
    ...
    const a = Dn("_bloom_:v1beta4:pageview");
    up().event(a);
  }
}
function vp() {
...
function qp() {
  hp() ? sa("User opted-out of telemetry, skipping initial ping.") : (n("Sending initial telemetry ping..."), up().a(function(a) {
    ...
    hp() ? sa("User opted-out of telemetry, skipping initial events.") : (a = Dn("_bloom_:v1beta4:library"), up().event(a, {distribution:"js-client"}));
...
l("bloombox.setup", function(a, c, b, d, f) {
  a && c ? (f = Object.assign({}, wa, f || {}, {key:b, G:a, location:c}), va(f), n("BBJS is initializing.", {version:"v2.0.0-rc4", debug:!0, config:f, variant:"full"}), pp(a, c, b, function() {
    un(a, c, b, function() {
      gp(a, c, b, function() {
        d();
      });
