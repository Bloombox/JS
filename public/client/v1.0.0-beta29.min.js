...
c=O(b);null!=c&&z(d,8,c,Ye);c=K(b,Se,9);null!=c&&z(d,9,c,Te);c=K(b,ef,10);null!=c&&z(d,10,c,gf);c=K(b,hf,11);null!=c&&z(d,11,c,jf);c=b.G();null!=c&&z(d,12,c,we);c=new Uint8Array(d.b+d.a.length());f=d.c;g=f.length;for(x=e=0;x<g;x++)q=f[x],c.set(q,e),e+=q.length;f=d.a.end();c.set(f,e);d.c=[c];d=[];for(e=0;e<c.length;e+=32768)d.push(String.fromCharCode.apply(null,c.subarray(e,e+32768)));JSON.stringify(a);JSON.stringify(Object.assign({},{payload:a.payload}));b=new bg(0,"EVENT",this.Ib,this.Gb,a,b);Tg(b)};
h.Oa=function(a){if(!E(a,3,""))throw new Xf("Missing device fingerprint ID.");if(!E(a,4,""))throw new Xf("Missing device session ID.");};function dh(a,b,c,d){this.c=a;this.h=d||+new Date;a=new Yf(this.c);ch.apply(this,[a,"EVENT",b,this.h])}m(dh,ch);dh.prototype.m=function(){return this.c.name.startsWith("_bloom_")};dh.prototype.Oa=function(a){ch.prototype.Oa.apply(this,[a]);if(!this.m&&(a=nf(a).K(),-1===a.indexOf("partner/")||-1===a.indexOf("location/")))throw new Xf("Must specify a location code before sending analytics events.");};
dh.prototype.a=function(){var a=new uf,b=new De,c={event:{payload:this.b}},d=+new Date;Ge(b,this.h||d);c&&"object"===typeof c&&(c=ce(c),L(a,1,c));L(a,2,b);return a};function eh(a){return["_bloom_:v1beta3",a].join(":")}var fh=eh("library"),gh=eh("pageview"),hh=eh("orders"),ih=eh("enrollment"),jh=eh("verification");function kh(a,b,c,d){a="string"!==typeof a?a:Kf(a);return new dh(a,b,null,d)}l("bloombox.telemetry.event",kh);l("bloombox.shop.enroll.EnrollmentException",function(a){this.message=a});function U(a,b,c,d,e,f,g){this.b=this.key=this.id=null;this.source=a;this.channel=b;this.person=c;this.doctorRec=d;this.license=e;this.a=null!==f&&void 0!==f?btoa(f):null;this.profile=g||null;this.dryRun=!1}l("bloombox.shop.enroll.Enrollment",U);U.prototype.l=function(){return this.id};U.prototype.getId=U.prototype.l;U.prototype.getKey=function(){return this.key};U.prototype.getKey=U.prototype.getKey;U.prototype.P=function(){return this.b};
U.prototype.getForeignId=U.prototype.P;U.prototype.ub=function(){this.dryRun=!0;return this};U.prototype.enableDryRun=U.prototype.ub;U.prototype.S=function(a,b,c,d){kh(ih,{action:c?"error":"enroll",status:d?d:200,customer:{foreignId:this.b.trim()},enrollment:{key:this.key.trim(),channel:this.channel,source:this.source}}).send()};
...
U.prototype.send=U.prototype.send;function lh(a){this.message=a}l("bloombox.shop.ShopInfoException",lh);
...
function ph(a){if("string"===typeof a||"number"===typeof a)switch(a){case "HALFGRAM":return 1;case 1:return 1;case "GRAM":return 2;case 2:return 2;case "EIGHTH":return 3;case 3:return 3;case "QUARTER":return 4;case 4:return 4;case "HALF":return 5;case 5:return 5;case "OZ":return 6;case 6:return 6}return 0}V.prototype.a=function(){var a=new je,b=this.key.a();L(a,1,b);H(a,3,this.count||1,0);this.b.map(function(b){Vd(a,2,b,he,void 0)});return a};
function qh(a,b,c){var d=new he;H(d,1,b,0);switch(b){case 2:d.setSize(c);break;case 0:J(d,2,ie[0],c);break;case 1:J(d,4,ie[0],c)}a.b.push(d);return a}V.prototype.Ua=function(a){return qh(this,0,a)};V.prototype.addWeightVariant=V.prototype.Ua;V.prototype.Ta=function(a){return qh(this,2,a)};V.prototype.addSizeVariant=V.prototype.Ta;V.prototype.Sa=function(a){return qh(this,1,a)};V.prototype.addColorVariant=V.prototype.Sa;function X(a,b){this.streetAddress=a;this.a=b||null}l("bloombox.shop.order.DeliveryLocation",X);X.prototype.b=function(){var a=new of,b=new pe;F(b,1,this.streetAddress.b);null!==this.streetAddress.a&&F(b,2,this.streetAddress.a);F(b,3,this.streetAddress.city);F(b,4,this.streetAddress.state);F(b,5,this.streetAddress.c);L(a,1,b);null!==this.a&&a.Na(this.a);return a};X.prototype.v=function(){return this.streetAddress};X.prototype.getAddress=X.prototype.v;X.prototype.Na=function(a){this.a=a};
X.prototype.setInstructions=X.prototype.Na;X.prototype.pb=function(){this.a=null};X.prototype.clearInstructions=X.prototype.pb;l("bloombox.shop.order.Type",{PICKUP:0,DELIVERY:1});var rh={PENDING:0,REJECTED:2,APPROVED:1,ASSIGNED:3,EN_ROUTE:4,FULFILLED:5};l("bloombox.shop.order.Status",rh);l("bloombox.shop.SchedulingType",{ASAP:0,TIMED:1});function Y(a){this.message=a}l("bloombox.shop.order.OrderException",Y);function sh(a,b){this.type=a;this.a=b}l("bloombox.shop.order.OrderScheduling",sh);function th(a){var b=new pf;H(b,1,a.type,0);if(null!==a.a){var c=new De;Ge(c,a.a);L(b,2,c)}return b}sh.prototype.j=function(){return this.type};
sh.prototype.getType=sh.prototype.j;sh.prototype.Xa=function(){return this.a};sh.prototype.getDesiredTime=sh.prototype.Xa;
...
l("bloombox.shop.order.Order",Z);Z.prototype.l=function(){return this.id};Z.prototype.getId=Z.prototype.l;Z.prototype.w=function(){return this.status};Z.prototype.getStatus=Z.prototype.w;Z.prototype.Fa=function(){return this.g.timestamp};Z.prototype.getCreatedAt=Z.prototype.Fa;Z.prototype.Mb=function(){this.f=new sh(0,null);return this};Z.prototype.setSchedulingTypeASAP=Z.prototype.Mb;
Z.prototype.Nb=function(a){if(!("number"===typeof a&&100<a))throw new Y("Invalid timestamp provided for setSchedulingTypeTimed.");this.f=new sh(1,a);return this};Z.prototype.setSchedulingTypeTimed=Z.prototype.Nb;Z.prototype.Y=function(){return this.f};Z.prototype.getScheduling=Z.prototype.Y;Z.prototype.B=function(a){if(0!==a&&1!==a)throw new Y("Invalid order type provided to Order.setType. Must be one of `bloombox.shop.order.Type.DELIVERY` or `bloombox.shop.order.Type.PICKUP`.");this.type=a;return this};
...
Z.prototype.update=Z.prototype.update;Z.prototype.S=function(a,b,c){var d=0,e={},f={},g=[],r=[];this.b.map(function(a){var b=a.key.l();d+=a.count;e[b]?e[b]+=a.count:(e[b]=a.count,g.push(b));b=a.key.Ia();f[b]?f[b]+=a.count:(f[b]=a.count,r.push(b))});kh(hh,{action:b?"error":"order",status:c?c:200,sid:bh(),order:{id:a,type:this.type,items:g,sections:r,stats:{countByKey:e,countBySection:f,hasOrderNotes:"string"===typeof this.J()&&0<this.J().length,uniqueItemCount:this.b.length,totalItemCount:d||1}}}).send()};
...
{orderId:f,orderType:q});else{q=uh(q);W=vh(W||0);var oa=new pf;if("object"===typeof d){var I=0;if(d.hasOwnProperty("scheduling")&&"object"===typeof d.scheduling&&("string"===typeof d.scheduling.scheduling||"number"===typeof d.scheduling.scheduling))switch(d.scheduling.scheduling.toUpperCase()){case "ASAP":I=0;break;case 0:I=0;break;case "TIMED":I=1;break;case 1:I=1;break;default:I=0}H(oa,1,I,0);I=null;d.hasOwnProperty("desiredTime")&&"object"===typeof d.desiredTime&&("string"===typeof d.desiredTime.iso8601?
I=+new Date(d.desiredTime.iso8601):"number"===typeof d.desiredTime.timestamp?I=d.desiredTime.timestamp:n("Unable to decode desired order time.",d),d=new De,Ge(d,I),L(oa,2,d))}d=Gf(e);a:{if("object"===typeof e&&"object"===typeof e.destination){e=e.destination;I=e.address;var Ih=e.instructions;if("object"===typeof I){var Qf=I.firstLine,Jh=I.secondLine||null,Rf=I.city,Sf=I.state,Tf=I.zipcode;if("string"===typeof Qf&&"string"===typeof Rf&&"string"===typeof Sf&&"string"===typeof Tf){e=new X(new Q(Qf,Jh,
Rf,Sf,Tf),Ih);break a}p("Failed to decode delivery address data.",{data:e,address:I})}}e=null}I=new De;B&&("object"===typeof B?"string"===typeof B.iso8601?Ge(I,+new Date(B.iso8601)):"number"===typeof B.timestamp?Ge(I,B.timestamp):n("Unable to type-identify order createdAt.",{data:B}):n("Unable to decode order createdAt.",{data:B}));B=new rf;F(B,1,f);L(B,10,I);B.B(q);H(B,3,W,0);L(B,5,oa);x&&B.ta(x);q=e;f=B.l();oa=B.j();x=B.w();W=B.J();x=vh(x);oa=uh(oa);try{var Kb=new Z(oa,d,q,W);Kb.id=f;Kb.status=
x;var kb=E(B.Fa(),2,0);Kb.g={timestamp:kb};if(Array.isArray(a)&&0<a.length)for(kb=0;kb<a.length;kb++){b:{var Ac=a[kb];if("object"===typeof Ac){var lb=Ac.key,Uf=Ac.count,Bc=Ac.variant;if("object"===typeof lb&&"number"===typeof Uf&&"string"===typeof lb.id){var Kh=lb.id;d=0;"object"===typeof lb.type&&lb.type.kind&&(d=oh(lb.type.kind));var Vf=new V(new nh(Kh,d),Uf||1);if(Bc&&Array.isArray(Bc))for(d=0;d<Bc.length;d++){var Da=Bc[d];q=Vf;"object"===typeof Da&&q&&("string"===typeof Da.weight||"number"===
typeof Da.weight?q.Ua(ph(Da.weight)):"string"===typeof Da.size?q.Ta(Da.size):"string"===typeof Da.color&&q.Sa(Da.color))}var Ud=Vf;break b}}Ud=null}null!==Ud?Kb.fa(Ud):n("Unable to decode order item. Skipping.",{index:kb,id:B.l()})}var Lh=Kb}catch(Wf){throw p("Failed to construct fetched Order object.",{error:Wf,orderId:f,status:x}),Wf;}b(null,Lh)}}}else p("Order retrieval RPC failed for unknown reason.",a),b(null,null)}},function(a){p("Order retrieval RPC failed with status: ",a);b(null,null,a)}):
p("Partner or location code is not defined.")}Z.retrieve=wh;
Z.prototype.send=function(a){var b=new rf;b.B(this.type);var c=bh();F(b,13,c);c=this.c;null!==c&&b.ta(c);c=this.a.a();b.sa(c);c=th(this.f);L(b,5,c);1===this.type&&(c=this.location.b(),L(b,6,c));this.b.map(function(a){a=a.a();b.fa(a)});var d=!1,e=t;c=e.A;e=e.location;if(c&&e){var f=this.b.map(function(a){return{count:a.count||1,key:{id:a.key.id,type:{kind:a.key.kind}},variant:a.b.map(function(a){var b={variant:E(a,1,0)};E(a,2,0)?b.weight=E(a,2,0):E(a,3,"")?b.size=E(a,3,""):E(a,4,"")&&(b.color=E(a,
4,""));return b})}});f={sid:E(b,13,""),type:b.j(),partnerCode:c,locationCode:e,customer:{person:{name:{firstName:this.a.person.name.O(),lastName:this.a.person.name.R()},contact:{email:{address:this.a.person.a.emailAddress},phone:{e164:this.a.person.a.phoneNumber}}},foreignId:this.a.b},scheduling:{scheduling:b.Y().Y()},item:f};"string"===typeof b.J()&&(f.notes=b.J());if(1===b.j()){if(!tf(b)||!tf(b).v())throw new Y("Missing destination information, but order type is DELIVERY.");f.destination={address:{firstLine:tf(b).v().na(),
city:tf(b).v().la(),state:tf(b).v().getState(),zipcode:tf(b).v().qa(),country:E(tf(b).v(),6,"")||"USA"}};b.J()&&(f.notes=b.J());tf(b).v().Z()&&(f.destination.address.secondLine=tf(b).v().Z());E(tf(b),2,"")&&(f.destination.instructions=E(tf(b),2,""))}(new If("SUBMIT_ORDER","POST",["partners",c,"locations",e,"orders"].join("/"),f)).send(function(b){if(!d){if(null!==b){d=!0;var c=new zf;b.error&&H(c,1,b.error,0);F(c,2,b.orderId);if(0===E(c,1,0)&&E(c,2,"")){this.id=E(c,2,"");a(E(c,2,""),this,null);this.S(E(c,
2,""));return}c=E(c,1,0);p("Server indicated order submission failed.",{response:b,error:c});a(null,null,c);this.S(null,c)}a(null,null)}}.bind(this),function(b){p("Order submission RPC failed with status: ",b);a(null,null,b);this.S(null,null,b)})}else p("Partner or location code is not defined.")};Z.prototype.send=Z.prototype.send;function xh(a){this.message=a}l("bloombox.shop.order.VerifyException",xh);
...
d.L();c={allowed:E(c,1,!1)};a&&(f&&"string"===typeof f&&(Yg=f),c.customer={person:{name:{firstName:d.U().O().trim(),lastName:d.U().R().trim()},contactInfo:{email:{address:d.U().a.ma().trim()},phone:{e164:d.U().a.pa().trim()}},dateOfBirth:{iso8601:d.U().Ha().trim()}},foreignId:d.P().trim(),userKey:d.L()});kh(jh,{action:"verify",verification:c}).send()}else n("Failed to inflate RPC.",a)}else n("Failed to inflate RPC.",a)},function(a){p(a?"Verification RPC failed with unexpected status: '"+a+"'.":"Verification RPC response failed to be decoded.")})}else p("Partner or location code is not defined.")});function yh(a){this.message=a}l("bloombox.shop.ZipcheckException",yh);
