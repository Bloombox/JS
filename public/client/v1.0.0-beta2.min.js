...
t(ic,C);function jc(a){D(this,a,null,null)}t(jc,C);function kc(a,b){a=E(a,1,"");0<a.length&&z(b,1,a)}function lc(a){D(this,a,null,null)}t(lc,C);lc.prototype.F=function(){return E(this,1,"")};function mc(a){D(this,a,null,null)}t(mc,C);mc.prototype.B=function(){return H(this,lc,1)};mc.prototype.F=function(){return E(this,2,"")};function nc(a){D(this,a,null,null)}t(nc,C);nc.prototype.M=function(a){I(this,1,a)};function oc(a){D(this,a,null,null)}t(oc,C);oc.prototype.Ca=function(){return E(this,1,0)};
...
Cc.prototype.ba=function(a){Qb(this,2,Dc[0],a)};function Ec(a){D(this,a,null,null)}t(Ec,C);function L(a){D(this,a,null,Fc)}t(L,C);var Fc=[[1]];function Gc(a,b){a=Ob(a,1);null!=a&&z(b,1,a)}L.prototype.getName=function(){return E(this,1,"")};function M(a){D(this,a,null,null)}t(M,C);function Hc(a,b){var c=a.B();0<c.length&&z(b,1,c);c=E(a,2,"");0<c.length&&z(b,2,c)}M.prototype.B=function(){return E(this,1,"")};function N(a){D(this,a,null,null)}t(N,C);
...
O.prototype.b=function(){return{section:this.sections?Array.from(this.sections):[],feeling:this.feelings?Array.from(this.feelings):[],tasteNote:this.tastes?Array.from(this.tastes):[],grow:this.grows?Array.from(this.grows):[],species:this.species?Array.from(this.species):[],cannabinoidRatio:this.a,desiredPotency:this.potency}};O.prototype.Xa=function(){this.sections.clear();return this};O.prototype.clearSections=O.prototype.Xa;O.prototype.Oa=function(a){this.sections.add(a);return this};
O.prototype.addSection=O.prototype.Oa;O.prototype.Ya=function(){this.species.clear();return this};O.prototype.clearSpecies=O.prototype.Ya;O.prototype.Qa=function(a){this.species.add(a);return this};O.prototype.addSpecies=O.prototype.Qa;O.prototype.Va=function(){this.grows.clear();return this};O.prototype.clearGrows=O.prototype.Va;O.prototype.Na=function(a){this.grows.add(a);return this};O.prototype.addGrow=O.prototype.Na;O.prototype.Ua=function(){this.feelings.clear();return this};
O.prototype.clearFeelings=O.prototype.Ua;O.prototype.Ma=function(a){this.feelings.add(a);return this};O.prototype.addFeeling=O.prototype.Ma;O.prototype.Za=function(){this.tastes.clear();return this};O.prototype.clearTastes=O.prototype.Za;O.prototype.Ra=function(a){this.tastes.add(a);return this};O.prototype.addTaste=O.prototype.Ra;O.prototype.mb=function(a){this.potency=a;return this};O.prototype.setPotency=O.prototype.mb;function P(a){this.message=a}q("bloombox.identity.StreetAddress",function(a,b,c,d,e,f){if(!a||"string"!==typeof a)throw new P("Invalid first address line: '"+a+"'.");if(!c||"string"!==typeof c)throw new P("Invalid address city: '"+c+"'.");if(!e||"string"!==typeof e)throw new P("Invalid address zip: '"+e+"'.");if(!d||"string"!==typeof d)throw new P("Invalid address state: '"+d+"'.");this.firstLine=a;this.secondLine=b||null;this.city=c;this.state=d;this.zip=e;this.country=f||"USA"});
...
e.toUpperCase();this.country=f||"USA"});function Q(a){this.message=a}q("bloombox.shop.CustomerException",Q);function bd(a,b){if(!("string"===typeof b&&0<b.length))throw new Q("Invalid customer foreign ID. Must be a valid string over length 1.");this.person=a;this.foreignId=b}q("bloombox.shop.Customer",bd);bd.prototype.lb=function(a){if(null!==a&&("+"!==a[0]||5>a.length||16<a.length))throw new Q("Invalid phone number: "+a);this.person.contactInfo.phoneNumber=null===a?null:a;return this};bd.prototype.setPhoneNumber=bd.prototype.lb;
...
new ld(b,this))}function Dd(a){a=a[wd];return a instanceof sd?a:null}var Ld="__closure_events_fn_"+(1E9*Math.random()>>>0);function Bd(a){if("function"==na(a))return a;a[Ld]||(a[Ld]=function(b){return a.handleEvent(b)});return a[Ld]};function S(){R.call(this);this.b=new sd(this);this.Ka=this;this.ja=null}t(S,R);S.prototype[nd]=!0;S.prototype.removeEventListener=function(a,b,c,d){Hd(this,a,b,c,d)};
function T(a,b){var c,d=a.ja;if(d)for(c=[];d;d=d.ja)c.push(d);a=a.Ka;d=b.type||b;if(m(b))b=new kd(b,a);else if(b instanceof kd)b.target=b.target||a;else{var e=b;b=new kd(d,a);Pa(b,e)}e=!0;if(c)for(var f=c.length-1;0<=f;f--){var g=b.a=c[f];e=Md(g,d,!0,b)&&e}g=b.a=a;e=Md(g,d,!0,b)&&e;e=Md(g,d,!1,b)&&e;if(c)for(f=0;f<c.length;f++)g=b.a=c[f],e=Md(g,d,!1,b)&&e}
...
(this.a.timeout=this.h,this.a.ontimeout=p(this.Ia,this)):this.da=Nd(this.Ia,this.h,this)),U(this.A,te(this,"Sending request")),this.Z=!0,this.a.send(a),this.Z=!1}catch(f){U(this.A,te(this,"Send error: "+f.message)),ue(this,f)}};function we(a){return Wa&&ob(9)&&"number"==typeof a.timeout&&la(a.ontimeout)}function Ga(a){return"content-type"==a.toLowerCase()}
h.Ia=function(){"undefined"!=typeof ka&&this.a&&(this.o="Timed out after "+this.h+"ms, aborting",this.i=8,U(this.A,te(this,this.o)),T(this,"timeout"),this.abort(8))};function ue(a,b){a.c=!1;a.a&&(a.f=!0,a.a.abort(),a.f=!1);a.o=b;a.i=5;xe(a);ye(a)}function xe(a){a.ha||(a.ha=!0,T(a,"complete"),T(a,"error"))}h.abort=function(a){this.a&&this.c&&(U(this.A,te(this,"Aborting")),this.c=!1,this.f=!0,this.a.abort(),this.f=!1,this.i=a||7,T(this,"complete"),T(this,"abort"),ye(this))};
h.s=function(){this.a&&(this.c&&(this.c=!1,this.f=!0,this.a.abort(),this.f=!1),ye(this,!0));ne.D.s.call(this)};h.Fa=function(){this.g||(this.ia||this.Z||this.f?ze(this):this.jb())};h.jb=function(){ze(this)};
...
Z.prototype.nb=function(){this.b=new Y(0,null);return this};Z.prototype.setSchedulingTypeASAP=Z.prototype.nb;Z.prototype.ob=function(a){if(!("number"===typeof a&&100<a))throw new X("Invalid timestamp provided for setSchedulingTypeTimed.");this.b=new Y(1,a);return this};Z.prototype.setSchedulingTypeTimed=Z.prototype.ob;
...
var Uf=function(a,b,c){var d;return function(){var e=this,f=arguments,g=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c&&b.apply(e,f)},a);g&&b.apply(e,f)}}(2500,function(){Pe.P?Pe.P&&Pe.Ja?0<Qe().Ga&&(5<=Rf.a.j()?Uf():Sf()):Uf():u("Tick skipped: telemetry is not enabled.")},!0);function Vf(a){var b=Qf[a.a],c=Ye(),d=wf;rf(d.a,b,new uf(c,a,b));d.count++;Re=d.count;Uf()};function Wf(a,b,c,d,e){this.i=e||Ye();this.l=a;c&&Object.isFrozen&&!Object.isFrozen(c)&&Object.freeze(c);this.b=c||null;this.h=d||+new Date;this.f=this.g=null}h=Wf.prototype;h.kb=function(a){this.g&&"function"===typeof this.g&&this.g(a);this.g=null};h.ib=function(a,b,c){this.f&&"function"===typeof this.f&&this.f(a,b,c);this.f=null};h.abort=function(){Rf.abort(this.i)};
h.send=function(){this.f=this.g=null;if(null===jf){var a=w;var b=a.C||null;a=a.location||null;var c;null===kf&&((c=window.localStorage.getItem("bb:v1:t.df"))&&"string"===typeof c?kf=c:(kf=c=Ye(),window.localStorage.setItem("bb:v1:t.df",c)));c=kf;var d;null===lf&&((d=window.sessionStorage.getItem("bb:v1:t.sid"))&&"string"===typeof d?lf=d:(lf=d=Ye(),window.sessionStorage.setItem("bb:v1:t.sid",d)));d=lf;var e=new Sc,f=0;tb?f=1:ub?f=2:rb?f=3:Va?f=4:Ya&&(f=5);F(e,1,f);f=0;af?f=1:$e?f=3:Ze&&(f=2);F(e,2,
f);f=new L;G(f,1,Fc[0],kb);I(e,4,f);f=0;gb||fb||hb||ib?f=100:(cb||Ya)&&ab?f=5:cb||Ya?f=4:sb?f=200:bb?f=101:db&&(f=6);var g=new Jc,r=new L;G(r,1,Fc[0],bf);g.H(f);I(g,2,r);I(e,5,g);f=window.document.origin;g=new Nc;G(g,10,Oc[0],f);I(e,6,g);f=new Lc;g=new L;G(g,1,Fc[0],"v1.0.0-beta2");I(f,2,g);F(f,1,"full");I(e,3,f);jf=new ff(null,b,a,c,d,null,null,null,e)}a=jf.a();b=this.l.a().v();if(0===b.length)b=a;else{a=new a.constructor(Tb(a.v()));c=a.v();for(d=0;d<b.length;d++)e=b[d],void 0!==e&&(c[d]=e);b=a}this.ta(b);
a={payload:this.b};c={};H(b,N,1)&&H(b,N,1).getName()&&(c.collection={name:H(b,N,1).getName()});E(b,4,"")&&(c.fingerprint=E(b,4,""));E(b,5,"")&&(c.group=E(b,5,""));H(b,jc,2)&&E(H(b,jc,2),1,"")&&(c.user={uid:E(H(b,jc,2),1,"")});H(b,M,8)&&(d={},H(b,M,8).B()&&(d.partner=H(b,M,8).B()),E(H(b,M,8),2,"")&&(d.commercial=E(H(b,M,8),2,"")),c.scope=d);switch(Nb(b,Vc[0])){case 61:c.browser=hf(H(b,Sc,61))}a=Object.assign({},null===a?{}:a,{context:c});d=new Ab;c=H(b,N,1);null!=c&&A(d,1,c,Ic);c=H(b,jc,2);null!=c&&
