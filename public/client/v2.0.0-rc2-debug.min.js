...
function Mn(a, c, b, d, f, g, k, p, I, da, Ac, lh, Wo) {
  this.R = a || null;
  this.D = d || null;
  this.Ba = Ac || null;
  this.c = f || null;
...
function Uo() {
  if (null === No) {
    ...
    if (window.screen) {
      ...
      let Ac = window.screen.availWidth;
...
l("bloombox.setup", function(a, c, b, d, f) {
  a && c ? (f = Object.assign({}, wa, f || {}, {key:b, G:a, location:c}), va(f), n("BBJS is initializing.", {version:"v2.0.0-rc2", debug:!0, config:f, variant:"full"}), pp(a, c, b, function() {
    un(a, c, b, function() {
      gp(a, c, b, function() {
        d();
      });
