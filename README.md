...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v1.0.8.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v1.0.8-debug.min.js"></script>
```
