...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v1.0.1-rc2.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v1.0.1-rc2-debug.min.js"></script>
```
