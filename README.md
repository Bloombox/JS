...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.1.1.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.1.1-debug.min.js"></script>
```
