...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0b2.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0b2-debug.min.js"></script>
```
