...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0-rc4.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0-rc4-debug.min.js"></script>
```
