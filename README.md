...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.2.0-alpha1.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.2.0-alpha1-debug.min.js"></script>
```
