...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0-rc6.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.0.0-rc6-debug.min.js"></script>
```
