...
<html>
  ...
  <script type="text/javascript" src="https://app.bloomware.media/client/v1.0.0-alpha2.min.js"></script>
...
```html
  <script type="text/javascript" src="https://app.bloomware.media/embed/client/shop/v1.0.0-alpha2-debug.min.js"></script>
```
