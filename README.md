...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.2.0.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.2.0-debug.min.js"></script>
```
