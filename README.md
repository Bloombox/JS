...
```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.1.0-rc5.min.js"></script>
```

and...

```html
  <script type="text/javascript" src="https://js.bloombox.cloud/client/v2.1.0-rc5-debug.min.js"></script>
```
